...
// [REVIEW]
// 현재 구조에서는 삭제 전에 댓글 개수를 먼저 조회하고 있기 때문에,
// 실제 삭제 후의 상태를 정확히 반영하지 못하는 오류 가능성이 있음.
// "댓글 삭제 후"라는 주석은 오해를 불러일으킬 수 있음.
// 또한 히스토리 삭제 기준이 (article_id, user_id)로 설정되어 있어
//history_id를 단일 기본키로 수정하게 된다면 함께 수정되어야 한다.
